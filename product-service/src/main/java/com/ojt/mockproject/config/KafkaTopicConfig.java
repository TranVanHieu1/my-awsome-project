...
public class KafkaTopicConfig {
    ...
    @Bean NewTopic cashoutMessageTopic() {  return new NewTopic("cashout-message-topic", 1, (short) 1); }

    @Bean NewTopic buyCourseSuccessMessageTopic() {
        return new NewTopic("buy-courses-success-by-wallet", 1, (short) 1);
    }
}